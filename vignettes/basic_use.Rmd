...
```{r}
r <- compare(d, iters = 1000, metrics=c("bootstrap_t", "wilcoxon", "rank_product"), 
             control = '665e6428', 
             c_seconds = '0', 
             treatment = '665e6428', 
             t_seconds = '150')
...
plot_heatmap(many, metric = "bootstrap_t_p_val", log = TRUE,  col_order = c("665e6428_150-665e6428_0", "665e6428_0-665e6428_150"))
