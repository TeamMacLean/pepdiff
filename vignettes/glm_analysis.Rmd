...
Let's create data with treatment (ctrl/trt) and timepoint (0h/24h). We use 5 replicates per condition (20 total per peptide) and 3-fold effects to ensure good power for detecting both main effects and interactions.
...
strat_summary <- results_stratified$results %>%
  ...
  tidyr::pivot_wider(names_from = comparison, values_from = fc)
